...
const Team = () => {
  const getCategory = (role: string) => {
    ...
    if (
      ...
      (r.includes("lead") && !r.includes("core"))
    )
      return "Leadership";

    if (r.includes("cp") || r.includes("competitive"))
    ...
    if (r.includes("android") || r.includes("app"))
      return "Android Development";
    if (r.includes("iot") || r.includes("embedded"))
  ...
  const categories = {
    ...
    "Competitive Programming": {
      ...
      description: "Mastering algorithms and logic.",
    },
    "Web Development": {
      icon: Code2,
      color: "text-google-blue",
      description: "Crafting the digital experiences.",
    },
    "AI/ML & Data Science": {
      icon: Brain,
    ...
    "Android Development": {
      ...
      description: "Building for the mobile world.",
    },
    ...
    "Graphic Design": {
      icon: Palette,
      color: "text-google-red",
      description: "Visualizing our identity.",
    },
    Photography: {
      icon: Camera,
      color: "text-google-yellow",
      ...
      <div className="absolute inset-0 z-[-1] pointer-events-none">
        <div className="sticky top-0 h-screen w-full overflow-hidden bg-[#fafafa]">
          ...
          >
            ...
            <path
              d="M-100 200 C 400 400, 800 0, 1540 200"
              stroke="#E5E5E5"
              strokeWidth="2"
              fill="none"
            />
            <path
              d="M-100 300 C 400 500, 800 100, 1540 300"
              stroke="#E5E5E5"
              strokeWidth="2"
              fill="none"
            />
            <path
              d="M-100 400 C 400 600, 800 200, 1540 400"
              stroke="#E5E5E5"
              strokeWidth="2"
              fill="none"
            />
            <path
              d="M-100 500 C 400 700, 800 300, 1540 500"
              stroke="#E5E5E5"
              strokeWidth="2"
              fill="none"
            />
            <path
              d="M-100 600 C 400 800, 800 400, 1540 600"
              stroke="#E5E5E5"
              strokeWidth="2"
              fill="none"
            />
          ...
          <AnimatedSection>
            <div className="text-center mb-24">
              <h1 className="heading-lg max-w-3xl mx-auto">
                ...
                <span className="text-black">GDG On Campus</span>
              </h1>
            </div>
          </AnimatedSection>
                  ...
                  <div key={category} className="relative">
                    <AnimatedSection delay={0.1}>
                      <div className="relative mb-12 pl-6 md:pl-8 border-l-2 border-neutral-100">
                        ...
                        <div
                          className={`absolute -left-[3px] top-0 h-16 w-[4px] ${info.color.replace("text-", "bg-")} rounded-full`}
                        ></div>
                        ...
                        <div className="flex items-center gap-3 mb-3">
                          ...
                          <div
                            className={`flex items-center gap-1.5 px-2 py-0.5 rounded-full bg-neutral-50 border border-neutral-100 ${info.color}`}
                          >
                                ...
                                <div className="aspect-[3/4] md:aspect-[4/4.5] relative w-full">
                                  ...
                                  <div className="absolute bottom-0 left-0 right-0 p-2 md:p-4 translate-y-2 group-hover:translate-y-0 transition-transform duration-300">
                                    ...
                                    <div className="flex items-center justify-between border-t border-white/20 pt-1 md:pt-2">
                                      <p className="text-[10px] md:text-xs text-white/90 font-medium truncate pr-1">
                                        {member.role}
                                      </p>
                                      <a
