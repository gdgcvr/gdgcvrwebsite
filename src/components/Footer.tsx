  ...
  return (
    <footer className="bg-secondary/30 border-t border-black/5 relative overflow-hidden">
      <div className="w-full max-w-7xl mx-auto px-6 md:px-8 py-16 md:py-24">
          ...
          <div className="md:col-span-7 lg:col-span-8 flex flex-col items-start justify-between">
            <div className="max-w-2xl z-10">
              ...
              <a
                ...
                target="_blank"
                rel="noreferrer"
                className="inline-flex items-center justify-center gap-2 px-8 py-4 rounded-full bg-foreground text-background font-medium hover:bg-foreground/90 transition-all group"
              >
                Join the Chapter
        ...
        {/* Bottom Info Bar */}
        <div className="mt-20 pt-8 border-t border-black/5 flex items-center gap-4">
